 ...
 */
async function createFantasyFootballSchema() {
...
function insertSampleData(db, resolve, reject) {
    ...
    const samplePlayers = [
        ...
        "INSERT OR IGNORE INTO nfl_players (name, position, nfl_team, jersey_number, bye_week) VALUES ('Cooper Kupp', 'WR', 'LAR', 10, 6)",
...
module.exports = { createFantasyFootballSchema };
